package com.humanid.humanidui.presentation.phonenumberemail
...
import com.humanid.humanidui.util.extensions.isEnabled
...
import com.humanid.humanidui.util.validation.util.onClick
    ...
    override fun setupFormValidation() {
        addValidation(
                Validation(
                        edtPhoneNumber,
                        listOf(
                            com.humanid.humanidui.util.validation.util.notEmptyRule(getString(string.error_field_required)),
                            com.humanid.humanidui.util.validation.util.numberOnlyRule(getString(string.error_number_format))
                        )
                )
        )
        ...
        addValidation(
                Validation(
                        ...
                        listOf(
                            com.humanid.humanidui.util.validation.util.notEmptyRule(getString(string.error_field_required)),
                            com.humanid.humanidui.util.validation.util.emailRule(getString(string.error_email_format))
                        )
                )
        )
    }
